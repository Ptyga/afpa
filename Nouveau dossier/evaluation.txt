...
function exercice1() {
    ...
    pap2 = pap + port
    console.log(pap2)
    document.getElementById("exo1").innerHTML = "<p>Le prix à payer est de " + pap2 + " €.</p>"
}
...
function exercice6() {
    ...
    console.log(map)
    var prenom = document.getElementById('name').value.toLowerCase()
    ...
    console.log(tab)
    document.getElementById('exo6').innerHTML = "<p>Voici votre nouveau tableau : " + map + "</p>"
}
